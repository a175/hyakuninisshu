...
\begin{theoremX}
  ...
  $C_1$と$C_2$の共通外接線を$l_3$, $l'_3$とし, その交点を$P_3$とする.
  $C_2$と$C_3$の共通外接線を$l_1$, $l'_1$とし, その交点を$P_1$とする.
  $C_1$と$C_3$の共通外接線を$l_2$, $l'_2$とし, その交点を$P_2$とする.
  $P_1$と$P_2$を通る直線を$l$とする.
  このとき,
  $P_3$は, $l$上にある.
\end{theoremX}
\cite{wiki:モンジュの定理}
